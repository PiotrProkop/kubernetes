...
const (
	PreferClosestNUMA string = "prefer-closest-numa-nodes"
)
...
type TopologyManagerOptions struct {
	PreferClosestNUMA bool
}

func NewTopologyManagerOptions(policyOptions map[string]string) (TopologyManagerOptions, error) {
